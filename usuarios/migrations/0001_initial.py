    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('floricultor', 'Floricultor / Productor'), ('comprador_b2b', 'Comprador Mayorista (B2B)'), ('comprador_b2c', 'Cliente Final (B2C)')], default='comprador_b2c', max_length=20)),
                ('nombre_empresa_o_finca', models.CharField(blank=True, max_length=100, null=True)),
